...
Most functions are similar to, and return the same values as, functions in R. 
 ...
 - **Standard infix operators**: addition `+`, subtraction/negation `-`, multiplication `*`, division `/`, exponentiation `^`, modulus `%` (equivalent to `%%` in R)
